...
exports.initIframe = exports.getSrcIframe = void 0;
exports.getSrcIframe = function (name) {
...
exports.initIframe = function (id) {
    try {
        var iframe = document.createElement('iframe');
        iframe.style.display = "block";
        iframe.src = exports.getSrcIframe("test");
        var insert_div = document.getElementById(id);
